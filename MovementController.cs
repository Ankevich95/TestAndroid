...
namespace SpaceShooter
{
    public class MovementController : MonoBehaviour
    {
        ...
        [SerializeField] private PointerClickHold m_MobileFirePrimery;
        ...
        private void Start()
        {
            if(m_ControlMode == ControlMode.Keyboard)
            {
                ...
                m_MobileFirePrimery.gameObject.SetActive(false);
            ...
            else
            {
                ...
                m_MobileFirePrimery.gameObject.SetActive(true);
        ...
        private void ControlMobile()
        {
            ...
            if (m_MobileFirePrimery.IsHold == true)
            {
